...
<style>
    ...
    .btn { display: inline-block; padding: 6px 10px; margin: 2px; text-decoration: none; border-radius: 3px; font-size: 11px; }
    .btn-edit { background: #007cba; color: white; }
    .btn-delete { background: #dc3545; color: white; }
    .btn-add { background: #28a745; color: white; padding: 10px 15px; margin: 10px 0; font-size: 14px; }
    ...
    if (deleteType != null && deleteId != null) {
        ...
        try {
            if ("train".equals(deleteType)) {
                ...
                message = result > 0 ? "<p class='success'>Train deleted successfully!</p>" : "<p class='error'>Failed to delete train.</p>";
                ...
                ps.setString(1, deleteId);
                int result = ps.executeUpdate();
                message = result > 0 ? "<p class='success'>Stop deleted successfully!</p>" : "<p class='error'>Failed to delete stop.</p>";
            }
        } catch (Exception e) {
...
<div class="container">
    ...
    <div class="section">
        <h2>🚆 Trains</h2>
        <a href="addTrain.jsp" class="btn btn-add">➕ Add New Train</a>
        ...
        while(trainsResult.next()){
            ...
            out.print("<td>");
            out.print("<a href='editTrain.jsp?id=" + trainId + "' class='btn btn-edit'>✏️ Edit</a>");
            out.print("<a href='manageSchedules.jsp?deleteType=train&deleteId=" + trainId + "' class='btn btn-delete' onclick='return confirm(\"Delete this train? This will also delete all reservations for this train.\")'>🗑️ Delete</a>");
            out.print("</td>");
            out.print("</tr>");
        }
        %>
    ...
    <div class="section">
        <h2>🛤️ Transit Lines</h2>
        <a href="addTransitLine.jsp" class="btn btn-add">➕ Add New Transit Line</a>
        ...
        while(linesResult.next()){
            ...
            out.print("<td>");
            out.print("<a href='editTransitLine.jsp?name=" + java.net.URLEncoder.encode(lineName, "UTF-8") + "' class='btn btn-edit'>✏️ Edit</a>");
            out.print("</td>");
            out.print("</tr>");
        }
        %>
    ...
    <div class="section">
        ...
        <a href="addStation.jsp" class="btn btn-add">➕ Add New Station</a>
        <a href="addStop.jsp" class="btn btn-add">➕ Add New Stop</a>
        ...
        while(stopsResult.next()){
            ...
            out.print("<td>");
            out.print("<a href='editStop.jsp?id=" + stopId + "' class='btn btn-edit'>✏️ Edit</a>");
            out.print("<a href='manageSchedules.jsp?deleteType=stop&deleteId=" + stopId + "' class='btn btn-delete' onclick='return confirm(\"Delete this stop?\")'>🗑️ Delete</a>");
            out.print("</td>");
            out.print("</tr>");
        }
